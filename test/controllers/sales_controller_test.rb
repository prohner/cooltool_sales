...
class SalesControllerTest < ActionController::TestCase
  ...
  test "should update sale" do
    patch :update, id: @sale, sale: { country_id: @sale.country_id, currency_of_proceeds: @sale.currency_of_proceeds, customer_currency: @sale.customer_currency, customer_price: @sale.customer_price, proceeds: @sale.proceeds, units: @sale.units }
    assert_redirected_to sale_path(assigns(:sale))
  end
